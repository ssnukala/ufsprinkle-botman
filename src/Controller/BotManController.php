...
/**
 * BotMan controller : implements https://botman.io/2.0/web-widget : custom web widget functionality
 *
...
namespace UserFrosting\Sprinkle\BotMan\Controller;
...
class BotManController extends SimpleController
{
    protected $botman;
    protected $config;
    /**
...
//     Debug::debug("line 31 config is : ",$this->config);
    ...
    public function chatResponse($request, $response, $args)
    {
        ...
        $schema = new RequestSchema('schema://botman.yaml');
